...
if (formaPagamento == "vista")
{
    ...
    Console.WriteLine($"O valor final da compra é de: {valorFinal}");
}
else
{
    ...
    Console.WriteLine($"O valor total é de {valorFinal}");
    Console.WriteLine($"Serão {parcelas} de {valorParcela}");
}